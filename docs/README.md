...
当前目标架构为 [V2-tech-design-wayfinder-pipeline.md](V2-tech-design-wayfinder-pipeline.md)，状态为 draft，对应尚未合并的 Wayfinder 实施与验收工作。V1 及其相关审查、诊断资料均为历史记录。
...
| V2 | tech-design | draft | [V2-tech-design-wayfinder-pipeline.md](V2-tech-design-wayfinder-pipeline.md) | V2 Wayfinder 会议纪要模式流水线 |
